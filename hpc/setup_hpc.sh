...
echo "║                                                                 ║"
echo "║  1. Start Neo4j (in a separate terminal):                       ║"
echo "║     module load java/17                                         ║"
echo "║     bash hpc/start_neo4j.sh                                     ║"
echo "║                                                                 ║"
echo "║  2. Wait ~30 sec, then check it's up:                           ║"
echo "║     curl http://localhost:7474                                   ║"
echo "║                                                                 ║"
echo "║  3. Edit .env (set OPENROUTER_API_KEY and NEO4J_PASSWORD)       ║"
echo "║                                                                 ║"
echo "║  4. Run ETL (builds graph from raw data):                       ║"
